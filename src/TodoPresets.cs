...
Holy Windmill ; 9 ; daily ; 0 ; 130 ; Secret chest: a boy spawns for a short time during the wisps (3rd room, left) - kill him. The chest after the final boss gives a Potion of Luck. 3 entries + 2 resets of 3: when the runs are used up, press Enter on the dungeon again to reset (1 Force Gem, then 2 = 3 FG a day, worth it). Force wing XP, myth XP.
Holy Keldrasil ; 6 ; daily ; 560k ; 150 ; Wing dungeon, menu requirement 560k CP (wiki: Lv150 + wing rank Rare level 100). 2 entries + 2 resets (press Enter again when out of runs; 1 then 2 Force Gems) = 6. More force wing XP than Windmill, Essence of Wing (Unique), myth XP.
