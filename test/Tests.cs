...
static class T {
  ...
  static int Main(){
    ...
    Check(TodoPresets.NameOf(TodoPresets.Catalog)=="Catalog v8" && cat.Find(i => i.Name=="Steamer Crazy").Target==30 && cat.Find(i => i.Name=="Holy Windmill").Tip.Contains("Mysterious Boy") && !cat.Exists(i => i.Name.StartsWith("Buy dungeon entries") || i.Name.StartsWith("White Gold") || i.Name=="Wing dungeon") && cat.Exists(i => i.Name=="Holy Windmill" && i.MinCp==0) && cat.Exists(i => i.Name=="Holy Shrine" && i.MinCp > 518000), "catalog header");
